...
- [Arduino IDE] Use "Tools -> Erase All Flash Before Sketch Upload" to show WifiManager screen again
- [Arduino IDE] Fix "A fatal error occurred: The chip stopped responding." by setting "Tools -> Upload Speed" to 115200
